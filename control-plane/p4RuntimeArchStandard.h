...
class P4RuntimeArchHandlerCommon : public P4RuntimeArchHandlerIface {
 protected:
    ...
    void addDigest(const P4RuntimeSymbolTableIface &symbols, p4configv1::P4Info *p4Info,
        ...
        if (serializedInstances.find(id) != serializedInstances.end()) {
            return;
        }
