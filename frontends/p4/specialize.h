...
class FindSpecializations : public Inspector {
 ...
 public:
    ...
    bool preorder(const IR::P4Parser *parser) override { return noParameters(parser); }
    bool preorder(const IR::P4Control *control) override { return noParameters(control); }
